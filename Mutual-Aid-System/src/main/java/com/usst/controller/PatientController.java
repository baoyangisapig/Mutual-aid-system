...
public class PatientController {
    ...
    @RequestMapping(value = "operation1",produces="text/html;charset=UTF-8;")
    public ModelAndView Upload1(ModelAndView mv){
        mv.setViewName("welcomepage/application.html");
        return mv;
    }
}
